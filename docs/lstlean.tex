...
% Modified by Hans-Dieter Hiep, 2019

\lstdefinelanguage{lean} {

% Nothing between $ becomes LaTeX math mode
mathescape=false,
% Comments may not include Latex commands (breaks UTF-8 extended characters)
texcl=false,
...
localrefinfo, recursor, derive
},

% Comments
morecomment=[l][\rmfamily]{--},
morecomment=[n][\rmfamily]{/-}{-/},
...
% Source file is also UTF-8
inputencoding=utf8,
% Enables ASCII chars 128 to 255
extendedchars=true,
% Dictionary for extended characters
literate=
{á}{{\'a}}1
{é}{{\'e}}1
{í}{{\'i}}1
